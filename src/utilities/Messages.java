...
public class Messages {
    ...
    public static final String ENT_PLAY_CARD = "Which card do you want to play? [0 to return to main menu]";
    public static final String ENT_ATK_CARD = "Choose card: [0 to return to main menu]";
    public static final String ENT_HEAL_CARD = "Which card do you want to heal? [9 to heal yourself] [0 to return to main menu]";
    public static final String ENT_DEF_CARD = "Which card do you want to attack? [9 to attack player] [0 to return to main menu]";
    public static final String ENT_DEBUFF_CARD = "Which card do you want to debuff? [0 to return to main menu]";
    public static final String ENT_BUFF_CARD = "Which card do you want to buff? [0 to return to main menu]";
